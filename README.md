...
### 2. Стартовая локация
![Стартовая локация](screenshots/start_loc.png)
*Первая локация, где начинается путь принца Элиана*

### 3. Встреча со стражем
![Королевский страж](screenshots/The%20guard.png)
*Диалог с королевским стражем*

### 4. Главные врата
![Главные врата](screenshots/main_doors.png)
*Величественные врата, ведущие в глубины замка*

### 5. Король
![Король](screenshots/king.png)
