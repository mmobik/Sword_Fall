...
### 1. Главное меню
![Главное меню](Game/screenshots/main_menu.png)
*Мрачное атмосферное главное меню с выбором начала игры и настроек*

### 2. Стартовая локация
![Стартовая локация](Game/screenshots/start_loc.png)
*Первая локация, где начинается путь принца Элиана*

### 3. Встреча со стражем
![Королевский страж](Game/screenshots/The%20guard.png)
*Диалог с королевским стражем - важный сюжетный момент*

### 4. Главные врата
![Главные врата](Game/screenshots/main_doors.png)
*Величественные врата, ведущие в глубины замка*

### 5. Король
![Король](Game/screenshots/king.png)
*Встреча с королём - судьбоносный диалог*
